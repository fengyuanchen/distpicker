...
var Distpicker = function () {
  ...
  Distpicker.prototype.init = function init() {
    var _this = this;
  ...
  Distpicker.prototype.bind = function bind() {
    var _this2 = this;
  ...
  Distpicker.prototype.unbind = function unbind() {
    if (this.$province) {
  ...
  Distpicker.prototype.output = function output(type) {
    var options = this.options,
  ...
  Distpicker.prototype.getList = function getList(data) {
    var list = [];
  ...
  Distpicker.prototype.getDistricts = function getDistricts() {
    var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_CODE;

    return DISTRICTS[code] || null;
  };

  Distpicker.prototype.reset = function reset(deep) {
    if (!deep) {
  ...
  Distpicker.prototype.destroy = function destroy() {
    this.unbind();
  };

  Distpicker.setDefaults = function setDefaults(options) {
